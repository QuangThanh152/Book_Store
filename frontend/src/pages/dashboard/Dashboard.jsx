     ...
     <section className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
              ...
              <div className="flex items-center p-8 bg-white rounded-lg shadow">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Sách thịnh hành trong tháng này</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white rounded-lg shadow">
            ...
            <section className="grid gap-6 md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col">
              <div className="flex flex-col bg-white rounded-lg shadow md:col-span-2 md:row-span-2">
                <div className="px-6 py-5 font-semibold border-b border-gray-100">Số lượng đơn đặt hàng mỗi tháng</div>
              ...
              <div className="flex items-center p-8 bg-white rounded-lg shadow">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Đơn đặt hàng còn lại</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white rounded-lg shadow">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Lượt truy cập trang web</span>
                </div>
              </div>
